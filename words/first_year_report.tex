...
I applied COGS to a set of six autoimmune traits for which dense finemapping summary statistics were available in \url{http://www.immunobase.org}. I added to this by modifying COGS to accept marginal posterior probabilities computed using GUESSFM,  for four traits, for which full genotype data was available. Due to \textit{blockshifter} results  I limited initial analysis to PCHi-C maps for activated and non-activated CD4$^{+}$ T cells, prioritising 256 genes. One of which, \textit{IL2RA}, was prioritised in CD4$^+$ T cells across multiple autoimmune diseases. Allele specific expression analysis of rs61839660, provided support for a PIR in intron 1  modulating expression of \textit{IL2RA}, in unactivated but on activated contexts.
